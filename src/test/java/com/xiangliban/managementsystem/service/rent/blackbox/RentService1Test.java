...
public class RentService1Test {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                // 边界值分析
                { 1, 3000, 1, 1, 1, 50, 1, 1, 1, "user#1", 1 },
                { 0, 3000, 1, 1, 1, 50, 1, 1, 1, "user#1", 2 },
                { -1, 3000, 1, 1, 1, 50, 1, 1, 1, "user#1", 2 },
                { 1, 3000, 1, 1, 0, 50, 1, 1, 1, "user#1", 2 },
                { 0, 3000, 1, 1, 0, 50, 1, 1, 1, "user#1", 2 },
                { -1, 3000, 1, 1, 0, 50, 1, 1, 1, "user#1", 2 },
                { 1, 3000, 1, 1, 1, 50, 1, 0, 1, "user#1", 2 },
                { 0, 3000, 1, 1, 1, 50, 1, 0, 1, "user#1", 2 },
                { -1, 3000, 1, 1, 1, 50, 1, 0, 1, "user#1", 2 },
                { 1, 3000, 1, 1, 0, 50, 1, 0, 1, "user#1", 2 },
                { 0, 3000, 1, 1, 0, 50, 1, 0, 1, "user#1", 2 },
                { -1, 3000, 1, 1, 0, 50, 1, 0, 1, "user#1", 2 },
        });
    }
